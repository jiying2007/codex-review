...
for (const name of ['index.js','safe-contract.js','codex-cli.js','process-runner.js','git-repository.js','context-builder.js','policy.js','review-rules.js','core-contract.json']) {
...
console.log('Review runtime boundaries verified against Codex Safe Core v4 with exact-line-only publication and contract manifest.');
