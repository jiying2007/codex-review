...
assert.strictEqual(expectedCore,'00403dd14877e978698c63d06f6dbdfe2ba9b8cc');
assert.strictEqual(productContract.productContractVersion,2);
assert.strictEqual(productContract.safeCoreRuntimeDigest,'a41fa0e2c02d1977d6f1f8e0b7efff0a3d220d1149498c3d4d5a4ecbb1b03808');
...
assert.match(marketplace,/distribution-receipt\.yml@00403dd14877e978698c63d06f6dbdfe2ba9b8cc/);
...
console.log('Release helper, Core 4.17 Product Contract, Consumer CI Receipt, manual-only exact-SHA Marketplace promotion, pinned vsce, Distribution Receipt, attestation and dependency governance tests passed.');
