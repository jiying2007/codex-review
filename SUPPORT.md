...
Current runtime trust root: Codex Safe Core v4.9.5 at exact commit `43e818dc9ae91051f55374a9f9a47b9df6420cd6`. `product-contract.json` and the `src/codex-safe-core` gitlink are authoritative; immutable historical schema URLs and release notes remain provenance records, not moving dependencies.
